...
const ICON_PATHS = {
  ...
  boxes: "M12 3 4 7v10l8 4 8-4V7l-8-4Zm0 0v8m8-4-8 4-8-4",
  ...
  stores: "M4 9 5.5 4h13L20 9M4 9v11h16V9M4 9h16M9 20v-6h6v6",
  ...
  cloud: "M7 18a4 4 0 0 1-.5-8A5.5 5.5 0 0 1 17 8.5 4.5 4.5 0 0 1 17 18H7Z",
  spark:
...
const BRAND_ICONS = {
  linkedin: (
    <>
      <rect x="2" y="2" width="20" height="20" rx="2" fill="" />
      <path
        d="M7 10v7M7 7.5h.01M11 10v7m0-4a2 2 0 0 1 4 0v4"
        stroke="white"
        strokeWidth="2"
        strokeLinecap="round"
