...
const ALL_COLUMNS = [
  ...
  },
  {
    ...
    header: "Year",
    sticky: true,
    render: (r) => r.reportYear ?? "—",
  },
  {
    key: "annualSummary",
    header: "Annual summary",
    render: (r) => r.annualSummary || "No summary provided",
  },
];
...
const IconChevron = ({ open }) => (
  <svg
    ...
    strokeLinejoin="round"
    aria-hidden="true"
    className={`yr-filter-bar__chevron${open ? " yr-filter-bar__chevron--open" : ""}`}
  >
    <path d="M6 9l6 6 6-6" />
  </svg>
);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const savedReport = selectedReport
        ? await yearlyReportService.updateReport(
            selectedReport.yearlyReportId,
            payload,
          )
      ...
      notify({
        ...
        title: selectedReport
          ? "Yearly report updated"
          : "Yearly report created",
      ...
      <div className="yr-filter-bar">
        ...
        <div className={`yr-filter-bar__body${filterOpen ? " is-open" : ""}`}>
          ...
          <div className="yr-toolbar">
                ...
                <>
                  ...
                  <div className="yr-column-panel">
                    ...
                    <div className="yr-column-panel__actions">
                      <button
                        type="button"
                        className="yr-column-panel__action-btn"
                      ...
                      {filteredColumnOptions.map((col) => (
                        ...
                        >
                          <input
                            ...
                            disabled={col.sticky}
                          />
                          <span className="yr-column-panel__item-label">
                            {col.header}
                          </span>
                          {col.sticky && (
                            <span className="yr-column-panel__always">
                              Always
                            </span>
                          )}
                        </label>
            ...
            <button
              type="button"
              className="yr-toolbar-btn yr-toolbar-btn--ghost"
              ...
              <div className="yr-saved-views__list">
                {savedViews.map((view) => (
                  <span key={view.id} className="yr-saved-views__chip">
                    <button
                      type="button"
                      className="yr-saved-views__chip-name"
                ...
                {pageItems.map((report) => (
                  ...
                  >
                    <div className="yr-report-card__header">
                      <span className="yr-report-card__store">
                        {report.storeName}
                      </span>
                      <span className="yr-report-card__year">
                        {report.reportYear}
                      </span>
                    </div>
                ...
                {selectedReport ? (
                  <div className="yr-detail-panel">
                    <div className="yr-detail-panel__header">
                      <div>
                        <h3 className="yr-detail-panel__store">
                          {selectedReport.storeName}
                        </h3>
                        <span className="yr-detail-panel__year">
                  ...
                  <div className="yr-detail-panel yr-detail-panel--empty">
                    <IconEmpty />
                    <p>
                      Select a report from the list to read its annual summary.
                    </p>
                  </div>
                )}
              </div>
