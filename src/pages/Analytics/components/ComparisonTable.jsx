  ...
  return (
    <th
      ...
      className={[
        ...
        column.sticky
          ? "comparison-table__cell--sticky comparison-table__th--corner"
          : "",
        ...
        <>
          <div className="comparison-table__scroll">
            <table className="comparison-table__table">
              ...
              {loading ? (
                <SkeletonBody
                  columns={columns.length ? columns : SKELETON_FALLBACK_COLUMNS}
                />
              ) : (
                <tbody>
                  {table.pagination.pageItems.map((row) => (
                    <tr
                      key={row.id}
                      className={`comparison-table__row${row.total ? " comparison-table__row--total" : ""}`}
                    >
                      {columns.map((column) => {
