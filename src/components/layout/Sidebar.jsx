    ...
    >
      <div className="app-sidebar__brand">
        <Link
          ...
          onClick={onNavigate}
        >
          <img src={isCollapsed ? horBadge : horLogo} alt="Hands Off Retail" />
        </Link>
        {!isCollapsed ? (
          <p className="app-sidebar__eyebrow">Control Room</p>
        ) : null}
      </div>
      ...
      <div className="app-sidebar__footer">
        ...
        >
          <span className="app-sidebar__link-icon">{NAV_ICONS.logout}</span>
          <span className="app-sidebar__link-label">Logout</span>
        </button>
      </div>
    </aside>
  );
